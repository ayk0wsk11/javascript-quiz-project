document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width =
      ((quiz.currentQuestionIndex / quiz.questions.length) * 100).toString() +
      "%";
  ...
  function nextButtonHandler() {
    ...
    let selectedAnswer = choices.reduce((acc, curr) => {
      if (curr.checked) {
        return curr.value;
      } else return acc;
    }, null);
    ...
    if (selectedAnswer === null) {
      console.log("nextButtonHandler(): no answer selected");
      return;
    }
    console.log("nextButtonHandler(): selected answer =>", selectedAnswer);
